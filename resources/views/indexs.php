...
<html lang="en-US" ng-app="employeeRecords">
    ...
    <body>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th>Contact No</th>
                        <th>Position</th>
                        <th><button id="btn-add" class="btn btn-primary btn-xs" ng-click="toggle('add', 0)"> + Empleado</button></th>
                    </tr>
                </thead>
                <tbody>
                    <tr ng-repeat="employee in employees">
                        ...
                        <td>
                            ...
                            <button class="btn btn-danger btn-xs btn-delete" ng-click="confirmDelete(employee.id)">Eliminar</button>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <script src="<?= asset('app/lib/angular-1.5.0/angular.min.js') ?>"></script>
